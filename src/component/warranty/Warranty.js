...
import { requestProductReturnAction } from '../../features/requestProductReturn/requestProductReturnAction';
const { TextArea } = Input;
export default function WarrantyPage(props) {
    ...
    function handleOnClickRequest() {
        ...
        dispatch(requestProductReturnAction(props.orderDetailId, isWarranty, series, description, fileList))
    }
    return (
        <>
            <Descriptions>
